...
namespace LibraryBook.Migrations
{
    public partial class addacc : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Login", "NicName", "Password", "RoleId" },
                values: new object[] { 1, "admin@gmail.ru", "Admin", "123456", 1 });
            ...
            //        table.ForeignKey(
            //            name: "FK_GenBooks_Books_BookId",
            //            column: x => x.BookId,
            //            principalTable: "Books",
            //            principalColumn: "Id",
            //            onDelete: ReferentialAction.Cascade);
            //        table.ForeignKey(
            //            name: "FK_GenBooks_Genres_GenreId",
            //            column: x => x.GenreId,
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_RateBooks", x => new { x.BookId, x.UserId });
            //        table.ForeignKey(
            ...
            //            onDelete: ReferentialAction.Cascade);
            //        table.ForeignKey(
            //            name: "FK_RateBooks_Users_UserId",
            //            column: x => x.UserId,
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_GenBooks_BookId",
            //    table: "GenBooks",
            //    column: "BookId");

            //migrationBuilder.CreateIndex(
            //    name: "IX_RateBooks_UserId",
            //    table: "RateBooks",
            //    column: "UserId");
